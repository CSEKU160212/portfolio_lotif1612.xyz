                    ...
                    <div class="row xs-column-reverse section-separator vertical-middle-content home-padding">
                        <div class="col-sm-6">
                            <div class="mh-header-info">
                                ...
                                <h2 class="wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.2s">MD. ABDUL LOTIF</h2>
                                <h4 class="wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.3s">Student</h4>
                ...
                <div class="row section-separator">
                    <div class="col-sm-12 col-md-6">
                        <div class="mh-about-img shadow-2 wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.4s">
                            <img src="assets/images/admin/lotif2.png" alt="" class="img-fluid">
                        </div>
                    </div>
                    <div class="col-sm-12 col-md-6">
                        <div class="mh-about-inner">
                            <h2 class="wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.1s">About Me</h2>
                            <p class="wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.2s">Hello, I’m a Md. Abdul Lotif, Student, Computer Science & Engineering, Khulna University, Bangladesh
                             I am good at</p>
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-md-3">
                                    <div class="mh-address-footer-item dark-bg shadow-1 wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.3s">
                                        ...
                                        <div class="each-info">
                                            <h4>Address</h4>
                                            <address>
                                                Khan Bahadur Ahsanullah Hall, <br>
                                ...
                                <div class="col-sm-12 col-md-3">
                                    <div class="mh-address-footer-item dark-bg shadow-1 wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.5s">
                                        ...
                                        <div class="each-info">
                                            <h4>Email</h4>
                                            <a href="mailto:mh1612@cseku.ac.bd">lotif1612@cseku.ac.bd</a><br>
                                            <a href="mailto:mh1612@gmail.com">lotif1612@gmail.com</a><br>
                                            <a href="mailto:me@mh1612.xyz">me@lotif1612.xyz</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-12 col-md-3">
                                    <div class="mh-address-footer-item dark-bg shadow-1 wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.7s">
                                        ...
                                        <div class="each-info">
                                            <h4>Phone</h4>
                                            <a href="callto:(880)-8976-987">+880-1717059192</a><br>
                                            <a href="callto:(880)-8976-987">+880-1617059192</a>
                                        </div>
                                    </div>
                                </div>
